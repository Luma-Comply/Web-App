        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 text-center">
          <div>
            <div className="text-4xl md:text-5xl font-mono font-semibold text-white mb-2">
              <AnimatedNumber value={100} prefix="$" suffix="B+" duration={2} />
            </div>
          ...
          <div>
            <div className="text-4xl md:text-5xl font-mono font-semibold text-white mb-2">
              <AnimatedNumber value={16} suffix=" hrs" duration={2} />
            </div>
            <p className="text-white/90 text-sm md:text-base">
          ...
          <div>
            <div className="text-4xl md:text-5xl font-mono font-semibold text-white mb-2">
              <AnimatedNumber value={1.5} prefix="$" suffix="M+" duration={2} decimals={1} />
            </div>
            <p className="text-white/90 text-sm md:text-base">
